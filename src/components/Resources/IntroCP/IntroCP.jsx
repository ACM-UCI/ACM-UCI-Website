...
export default class IntroCP extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div className="intro-to-cp">
                ...
                <Container className="mt-4">
                    <Tabs defaultActiveKey="intro" id="intro-to-cp-tabs">
                        <Tab eventKey="intro" title="General Intro">
                            <Row>
                                <Col sm="12">
                                    {/** ******** INTRODUCTION ********* */}
                                    ...
                                    <ol>
                                        <li>
                                            ...
                                            One day you’ll develop “the eye” -
                                            i.e. you’ll learn to recognize each
                        ...
                        <Tab eventKey="io" title="Working With I/O">
                            <Row>
                                <Col sm="12">
                                    <h2 className="mt-3">
                                    ...
                                    <p className="problem-desc">
                                        &quot;Jack needs to copy several words.
                                        He will receive input as follows. The
                                        first line of input will be n, the
                                        number of words to copy. The next n
                                        lines will be the words to copy. Output
                                        those words to stdout.&quot;
                                    </p>
                                    ...
                                    <p className="problem-desc">
                                        &quot;Jack needs to copy several words.
                                        He will receive an unspecified number of
                                        words. Output those words to
                                        stdout.&quot;
                                    </p>
                                    ...
                                    <p className="problem-desc">
                                        &quot;Jack is given several rows of
                                        numbers. He needs to add up these rows
                                        of numbers and produce a sum. He is not
                                        told beforehand how many rows of numbers
                                        he will be given, but he does know that
                                    ...
                                    <p className="problem-desc">
                                        ...
                                        of numbers and produce a sum. He is not
                                        told beforehand how many rows of numbers
                                        he will be given, and he has no idea how
                                        many numbers each row will
                                        contain.&quot;
                                    </p>
